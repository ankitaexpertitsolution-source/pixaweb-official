        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-8">
              ...
              <button className="bg-neon-lime text-deep-black px-6 py-2 rounded-full font-semibold hover:bg-neon-lime/90 transition-all">
                Explore now
              </button>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-deep-black/95 backdrop-blur-lg border-t border-white/5">
          <div className="px-4 pt-2 pb-3 space-y-3">
            ...
            <button className="w-full bg-neon-lime text-deep-black px-6 py-2 rounded-full font-semibold mt-2">
              Explore now
            </button>
          </div>
        </div>

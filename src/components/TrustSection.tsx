        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 space-y-6">
              ...
              <div className="bg-deep-black/50 rounded-xl p-4">
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-neon-lime text-deep-black px-4 py-1 rounded-full text-sm font-semibold">
                    Withdraw
                  </button>
                </div>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="flex items-center space-x-2 bg-neon-lime text-deep-black px-6 py-3 rounded-full font-semibold hover:bg-neon-lime/90 transition-all">
                <span>Learn More</span>
                <ArrowRight size={18} />
              </button>
              <button className="flex items-center space-x-2 text-white px-6 py-3 rounded-full font-semibold border border-white/20 hover:border-neon-lime/50 transition-all">
